...
int execute(char *content, stack_t **head, unsigned int co, FILE *file);
...
void _sub(stack_t **head, unsigned int co);
void _div(stack_t **head, unsigned int co);
void _mul(stack_t **head, unsigned int co);
void _mod(stack_t **head, unsigned int co);
void _pchar(stack_t **head, unsigned int co);
void _pstr(stack_t **head, unsigned int co);
void _rotl(stack_t **head, unsigned int co);
